...
def clBot(op):
  ...
  "contents": [
    {
      ...
      "body": {
        "contents": [
          ...
          {
            "type": "image",
        "url": "https://i.top4top.io/p_1521lty361.png", #hp
        "aspectRatio": "4:4",
        "aspectMode": "cover",
        "size": "full",
          },
  ...
  "type": "carousel"
                    ...
                    try:
                        ...
                        ret_ += "\n╠ Version : Free v 1.1 by Cannibal"
                        ret_ += "\n╠ Creator : {}".format(creator.displayName)
                        ret_ += "\n╚ Git : https://github.com/cannibalkiller/daff4"
                  ...
                  "uri": search_url
                    ...
                    if msg.toType == 2:
                             ...
                             for x in range(jmlh):
                                 ...
                                 sendTextTemplate(msg.to, "The bot has been mmade with CBPheaders")
                             ...
                             for x in range(jmlh):
                                 ...
                                 sendTextTemplate(msg.to, "The bot has been mmade with CANNIBALheaders")
                                 cl.sendMessage(msg.to,str(res.authToken))
                             ...
                             for x in range(jmlh):
                                 ...
                                 sendTextTemplate(msg.to, "The bot has been mmade with CBPTEAMheader")
                                 cl.sendMessage(msg.to,str(res.authToken))
